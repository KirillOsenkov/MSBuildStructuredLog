...
namespace Microsoft.Build.Logging.StructuredLogger
{
    ...
    internal class BufferedBinaryReader : IDisposable
    {
        ...
        {
            FillBuffer(8);
            uint lo = (uint)(this.buffer[this.bufferOffset + 0] | this.buffer[this.bufferOffset + 1] << 8 |
                             this.buffer[this.bufferOffset + 2] << 16 | this.buffer[this.bufferOffset + 3] << 24);
            uint hi = (uint)(this.buffer[this.bufferOffset + 4] | this.buffer[this.bufferOffset + 5] << 8 |
                             this.buffer[this.bufferOffset + 6] << 16 | this.buffer[this.bufferOffset + 7] << 24);
        ...
        {
            FillBuffer(1);
            var result = (this.buffer[this.bufferOffset] != 0);
            this.bufferOffset++;
