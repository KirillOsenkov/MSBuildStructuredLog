...
namespace StructuredLogViewer.Avalonia.Controls
{
    public partial class SearchAndResultsControl : UserControl
    {
        ...
        {
            InitializeComponent();
            typingConcurrentOperation.DisplayResults += r => Dispatcher.UIThread.InvokeAsync(() => DisplaySearchResults(r));
            typingConcurrentOperation.SearchComplete += (text, arg) => Dispatcher.UIThread.InvokeAsync(() => TypingConcurrentOperation_SearchComplete(text, arg));
        }
