...
namespace StructuredLogViewer.Avalonia.Controls
{
    public class EditorExtension
    {
        ...
        public void Install(TextViewerControl textViewerControl)
        {
            ...
            textView.PointerHoverStopped += (sender, e) => CloseToolTip();
        }
            ...
            out string word)
        {
            ...
            var document = textViewerControl.TextEditor.Document;
            start = AvaloniaEdit.Document.TextUtilities.GetNextCaretPosition(
                document,
                offset + 1,
                LogicalDirection.Backward,
                CaretPositioningMode.WordBorder);
            end = AvaloniaEdit.Document.TextUtilities.GetNextCaretPosition(
                document,
                offset,
