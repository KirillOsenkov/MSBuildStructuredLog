...
{
    /// <summary>
    /// Full reference for the MSBuild Structured Log Viewer search query syntax.
    /// Returned verbatim by the <c>get_search_syntax_help</c> MCP tool.
    /// </summary>
    internal static class SearchSyntaxHelp
    {
        public const string Text = @"MSBuild Structured Log Viewer search query syntax
==================================================
